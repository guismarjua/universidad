...
@Named
@SessionScoped
public class ManualDeUsuarioMBean implements Serializable{

	final static Logger logger = Logger.getLogger(ManualDeUsuarioMBean.class);
	/**
	 * 
	 */
	...
	@PostConstruct
	public void init() {
		try (InputStream input = ManualDeUsuarioMBean.class.getClassLoader().getResourceAsStream("config.properties")) {
            if (input == null) {
