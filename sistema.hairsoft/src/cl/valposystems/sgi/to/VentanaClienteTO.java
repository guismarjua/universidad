...
public class VentanaClienteTO implements Serializable {
	
	/**
	 * 
	 */
	private static final long serialVersionUID = -473996913728642865L;
	...
	public VentanaClienteTO() {
		super();
		// TODO Auto-generated constructor stub
	}
	
	public VentanaClienteTO(String nombreUsuario, int idVentana, int idActividad, int idProyecto, int vigencia,
